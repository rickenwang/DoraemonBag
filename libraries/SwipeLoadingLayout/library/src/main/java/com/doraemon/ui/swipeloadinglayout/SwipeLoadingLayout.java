 ...
 *
 */
public class SwipeLoadingLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = SwipeLoadingLayout.class.getSimpleName();
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(SwipeLoadingLayout parent, @Nullable View child);
    }
}
